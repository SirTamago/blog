!function(t, e) {
    ...
    var s, r = function(t) {
        ...
        function t(t, e, i, s) {
            return this.x = t, this.y = e, this.width = i, this.height = s, this.top = this.y, 
        ...
        return void 0 === t && (t = 0), void 0 === e && (e = 0), void 0 === i && (i = !1), 
        ...
        var e = v(t);
        this.target = t, this.contentRect = e.contentRect, this.borderBoxSize = r([ e.borderBoxSize ]), 
        this.contentBoxSize = r([ e.contentBoxSize ]), this.devicePixelContentBoxSize = r([ e.devicePixelContentBoxSize ]);
    }, w = function(t) {
        if (h(t)) return 1 / 0;
        ...
        e.forEach(function(e) {
            if (0 !== e.activeTargets.length) {
                ...
                e.activeTargets.forEach(function(e) {
                    ...
                    s.push(i), e.lastReportedSize = F(e.target, e.observedBox), 
                    r < t && (t = r);
                }), i.push(function() {
        ...
        return e.some(function(t) {
            ...
            message: i
        }) : ((t = document.createEvent("Event")).initEvent("error", !1, !1), t.message = i), 
        window.dispatchEvent(t)), s > 0;
    }, A = [], b = function(t) {
        if (!s) {
        ...
        return t.prototype.run = function(t) {
            ...
            this.observe(), K.forEach(function(e) {
        ...
        return t.connect = function(t, e) {
            ...
            q(r.observationTargets, i) < 0 && (n && e.push(r), r.observationTargets.push(new J(i, s && s.box)), 
            f(1), B.schedule());
        }, t.unobserve = function(t, i) {
            var s = D.get(t), r = q(s.observationTargets, i), n = 1 === s.observationTargets.length;
            r >= 0 && (n && e.splice(e.indexOf(s), 1), s.observationTargets.splice(r, 1), 
            f(-1));
    ...
    var N = {
        chisato: {
            ...
            image: "https://rimrose.top/img/Scene_1000px_1.png",
            initialState: {
                i: .08,
                s: .1,
                d: .99,
        ...
        takina: {
            ...
            image: "https://images.rimrose.site/images/rimrose_lipai.png",
            initialState: {
                i: .08,
                s: .1,
                d: .988,
    ...
    class X {
        constructor(t = {}) {
            this._lastRunUnix = Date.now(), this._frameUnix = 1e3 / 60, this._running = !0, 
            this._magicForceTimeout = 0, this._magicForceEnabled = !1, this._resizeObserver = null, 
            this._updateLimit = t => {
                let e = t / 5;
                e < 30 ? e = 30 : e > 60 && (e = 60);
                const i = t / 4, s = -i;
                ...
                this._options.size = t, this._imageSize = this._options.size / 1.25, 
                this._canvasSize = 1.5 * this._options.size, this._domApp.style.width = `${t}px`, 
                this._domApp.style.height = `${t}px`, this._domCanvas.style.width = `${this._canvasSize}px`, 
                ...
                const e = function(t, e, i = 2 * (window.devicePixelRatio || 1)) {
                    ...
                    return r ? (r.setTransform(1, 0, 0, 1, 0, 0), r.scale(i, i), 
                    r) : null;
                }(this._domCanvas, this._canvasSize);
                if (!e) throw new Error("Invalid canvas context");
                this._domCanvasCtx = e, this._draw(), this._domMain.style.width = `${t}px`, 
                this._domMain.style.height = `${t}px`, this._domImage.style.width = `${this._imageSize}px`, 
                this._domImage.style.height = `${this._imageSize}px`, this._domImage.style.transformOrigin = `50% ${t}px`;
            }, this._updateDom = () => {
                ...
                r.className = "sakana-widget-img", r.style.backgroundImage = `url('${this._image}')`, 
                this._domImage = r, s.appendChild(r);
                ...
                a.role = "button", a.tabIndex = 0, this._options.title && (a.title = "Next Character"), 
                this._domCtrlPerson = a, n.appendChild(a);
                ...
                h.role = "button", h.tabIndex = 0, this._options.title && (h.title = "Auto Mode"), 
                this._domCtrlMagic = h, n.appendChild(h);
                const c = document.createElement("a");
                c.className = o, c.href = "//github.com/dsrkafuu/sakana-widget", 
                ...
                this._options.title && (c.title = "GitHub Repository"), n.appendChild(c);
                ...
                l.role = "button", l.tabIndex = 0, this._options.title && (l.title = "Close"), 
                this._domCtrlClose = l, n.appendChild(l);
                ...
                const {
                    ...
                    controls: s,
                    stroke: r
                } = this._options, n = this._domImage, o = this._imageSize, a = this._domCanvasCtx, h = 1 * t;
                if (n.style.transform = `rotate(${t}deg) translateX(${h}px) translateY(${e}px)`, 
                a.clearRect(0, 0, this._canvasSize, this._canvasSize), a.save(), 
                a.translate(this._canvasSize / 2, i + (this._canvasSize - i) / 2), 
                a.strokeStyle = r.color, a.lineWidth = r.width, a.lineCap = "round", 
                this._options.rod && a.beginPath(), s ? a.moveTo(0, -10) : a.moveTo(0, 10), 
                this._options.rod) {
                    const s = i - o / 2, {
                        nx: r,
                        ny: n
                    } = this._calcCenterPoint(t, s, h, e);
                ...
                const {
                    d: o,
                    i: a
                } = this._state, h = Date.now();
                let c = a;
                const l = h - this._lastRunUnix;
                l < 16 && (c = a / this._frameUnix * l), this._lastRunUnix = h, 
                n = n - 2 * i - t, i += n * c * 1.2, this._state.w = n * o, this._state.r = i, 
                r -= 2 * s, s += r * c * 2, this._state.t = r * o, this._state.y = s, 
                ...
                n = Math.max(-i, n), n = Math.min(i, n), e = e * this._state.s * 2, 
                e = Math.max(r, e), e = Math.min(s, e), this._state.r = n, this._state.y = e, 
                this._state.w = 0, this._state.t = 0, this._draw();
            }, this._onMouseDown = t => {
                ...
                const s = t => {
                    ...
                    document.removeEventListener("touchmove", s), document.removeEventListener("touchend", r), 
                    this._running = !0, requestAnimationFrame(this._run);
                };
                ...
                if (Math.random() < .1) {
                    ...
                    this.setCharacter(e);
                } else this._state.t = this._state.t + 150 * (Math.random() - .5), 
                this._state.w = this._state.w + 200 * (Math.random() - .5);
                this._running || (this._running = !0, requestAnimationFrame(this._run)), 
                ...
                clearTimeout(this._magicForceTimeout), this._magicForceEnabled && (this._magicForceTimeout = window.setTimeout(this._magicForce, 1e3 * Math.random() + 500));
            }, this.setState = t => (this._state || (this._state = {}), this._state = M(this._state, U(t)), 
            this), this.setCharacter = t => {
                const e = T[t];
                if (!e) throw new Error(`invalid character ${t}`);
                return this._char = t, this._image = e.image, this.setState(e.initialState), 
                ...
                this._domCtrlClose.addEventListener("click", this.unmount), this._options.autoFit && (this._onResize(this._domWrapper.getBoundingClientRect()), 
                ...
                return s.appendChild(this._domWrapper), i.replaceChild(s, e), requestAnimationFrame(this._run), 
                this;
            }, this.unmount = () => {
                ...
                this._domCtrlClose.removeEventListener("click", this.unmount), this._resizeObserver && this._resizeObserver.disconnect();
            ...
            }, null == T && Q(), this._options = U(z), this._options = M(this._options, t), 
            this.setCharacter(this._options.character), this._updateDom(), this._updateSize(this._options.size), 
